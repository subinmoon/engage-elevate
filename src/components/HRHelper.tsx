...
const helpItems = [
  { label: "결재", icon: FileText, color: "bg-isu-blue-light text-primary" },
  { label: "회의실", icon: Calendar, color: "bg-isu-green-light text-accent" },
  { label: "동료일정", icon: Users, color: "bg-isu-blue-light text-primary" },
  { label: "휴가", icon: Plane, color: "bg-isu-green-light text-accent" },
  { label: "조직도", icon: Building2, color: "bg-isu-blue-light text-primary" },
  { label: "직원검색", icon: UserCircle, color: "bg-isu-green-light text-accent" },
  { label: "식단", icon: UtensilsCrossed, color: "bg-isu-blue-light text-primary" },
  { label: "메일전송", icon: Mail, color: "bg-isu-green-light text-accent" },
];
